...
Iyzipay.prototype._validateIyzipayOptions = function(config) {
    if (typeof config['uri'] === 'undefined' || config['uri'] === '') throw new TypeError('uri cannot be emtpy');
    if (typeof config['apiKey'] === 'undefined' || config['apiKey'] === '') throw new TypeError('apiKey cannot be emtpy');
    if (typeof config['secretKey'] === 'undefined' || config['secretKey'] === '') throw new TypeError('secretKey cannot be emtpy');
};
